...
pub async fn copy_bidir((send_stream, recv_stream): (iroh::endpoint::SendStream, iroh::endpoint::RecvStream), mut tcp_stream: tokio::net::TcpStream) -> Result<(u64, u64), std::io::Error> {
